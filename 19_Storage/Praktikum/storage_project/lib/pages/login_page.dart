...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    String passwordValue =
        ""; // Digunakan ketika ingin mengetes validasi username & password
    String dummyToken =
        "dummy_token_123"; // Untuk simulasi menyimpan data token saja
                    ...
                    onPressed: () {
                      ...
                      if (usernameValue != "" && passwordValue != "") {
                        ...
                        Navigator.pushNamedAndRemoveUntil(context,
                            RoutesNavigation().homePage, (route) => false);
                      } else {
                      ...
                      if (usernameValue == "syabdewa" &&
                          passwordValue == "11223344") {
                        SharedPref().saveUserCredential(
                            tokenValue: dummyToken,
                            usernameValue: usernameValue);
                        Navigator.pushNamedAndRemoveUntil(context,
